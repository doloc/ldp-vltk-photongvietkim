...
const Section3 = () => {
  ...
  return (
    ...
    bg-[url('/images/section3_mb-bg.webp')] md:bg-[url('/images/section3_pc-bg.webp')] flex flex-col items-center">
      ...
      {/* <img src="/images/section3_char.webp" alt="" className="absolute bottom-[7%] right-[5.2%] w-[54.06%] object-contain" /> */}
      <img src="/images/section3_vs.webp" alt="" className="mt-[3%] w-[28.13%] md:w-[17.97%] object-contain" />
      <div className="absolute bottom-[17%] md:bottom-[25%] md:left-[5%] w-[67.6%] md:w-[37.03%] aspect-711/480 grid grid-cols-3 gap-[3%] content-center">
        {Array.from({ length: TOTAL }, (_, i) => (
          ...
          >
            <img src={`/images/section3_char-${i + 1}.webp`} alt="" className="w-full h-full object-contain" />
          </div>
        ))}
      </div>
      <img
        src="/images/section3_btn-fight.webp"
        alt=""
      ...
      {showPopup && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/50" onClick={() => setShowPopup(false)}>
          <div className="bg-[url('/images/card-bg.webp')] bg-cover bg-center w-[60%] md:w-[30%] aspect-196/230 flex flex-col items-center justify-center gap-[5%] px-[5%]">
            ...
            <img src="/images/btn-receive-reward.webp" alt="" className="w-[60%] object-contain img-btn" onClick={() => setShowPopup(false)} />
          </div>
        </div>
      )}
