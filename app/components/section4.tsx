const Section4 = () => {
  return (
    ...
    bg-[url('/images/section4_mb-bg.jpg')] md:bg-[url('/images/section4_pc-bg.jpg')] flex flex-col items-center">
      <img src="/images/section4_pc-title.png" alt="" className="hidden md:block w-[63.18%] object-contain" />
      <img src="/images/section4_mb-title.png" alt="" className="mt-[4%] md:hidden w-full object-contain" />
      ...
      <div className="w-[92.13%] md:w-[88%] aspect-1735/1180 bg-cover bg-center bg-no-repeat bg-[url('/images/section4_fr-ranking.png')] flex flex-col justify-start px-[7%] pt-[4%]">
        {/* Header */}
        ...
        {[
          ...
          >
            <div className="flex items-center justify-center">
              {i < 3 ? (
                <img src={`/images/icon-rank-${i + 1}.png`} alt={`rank ${i + 1}`} className="h-[3.5vw] object-contain" />
              ) : (
                <span>{i + 1}</span>
              )}
            </div>
